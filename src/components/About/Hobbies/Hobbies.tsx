    ...
    Chess: (
      <>
        ...
        <p>
          ...
          in Rust that is designed for speed and high accuracy move generation.
        </p>
      </>
    ),
    Japanese: (
      <>
        ...
        <p>
          ...
          traveled there with my wife and studied at KCP International Language
          School. During my time there, I was exposed so much Japanese culture
          and was very immersed in the language. Since that semester I have been
          back once and plan to in the future and still enjoy studying the
          language.
        </p>
      </>
    ),
    Reading: (
      <>
        ...
        <p>
          ...
          fantasy though. I really enjoy reading because it is a good way for me
          to wind down and relax in the evening.
        </p>
      </>
    ),
  };

  return <Tab title='Hobbies' tabs={hobbies}></Tab>;
}
